...
Unfortunately, the PEA game does not satisfy the mixability condition, so we cannot apply the regret bound in [this post on the AA](http://localhost:4000/blog/2017/03/02/aggregating-algorithm/).
